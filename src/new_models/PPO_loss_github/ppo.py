...
# --------------------------------------------------------------------------------
from DataCompression.src.new_models.PPO_loss_github.policies import ActorCriticPolicy, ActorCriticCnnPolicy
# --------------------------------------------------------------------------------
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                values, log_prob, entropy, latent, latent_log_var = self.policy.evaluate_actions(rollout_data.observations, actions)
